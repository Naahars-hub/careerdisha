-- Fixed Database Setup Script for Career Disha
-- Run this script in your Supabase SQL Editor to create all required tables
-- This version fixes the circular dependency issue
...
-- 2. Study Goals Table (must be created before study_sessions)
...
-- 3. Study Sessions Table (references study_goals)
...
-- 4. Results Table (for storing career map data)
...
WHERE schemaname = 'public' 
  AND tablename IN ('user_profiles', 'study_goals', 'study_sessions', 'results')
ORDER BY tablename;
